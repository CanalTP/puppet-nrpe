...
sub print_usage () {
        print "Usage:\n";
        print "  $PROGNAME [-w <min>] [-c <min>] [-W <size>] [-C <size>] -f <file>\n";
...
sub print_help () {
        ...
        print_usage();
        print "\n";
        print "  <min>  File must be no more than this many min old (default: warn 720 min, crit 1440)\n";
